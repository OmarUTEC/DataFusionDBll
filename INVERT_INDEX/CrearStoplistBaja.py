...
def generar_stopwords_desde_csv(ruta_csv_entrada, ruta_csv_stopwords_salida):
    ...
    # Paso 3: Tokenizar el texto y contar frecuencias de palabras y documentos en los que aparecen
    word_freq = Counter()
    ...
    # Paso 5: Generar la lista de stopwords basada en baja entropía
    ...
    with open(ruta_csv_stopwords_salida, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for word in sorted(palabras_baja_entropia):
            writer.writerow([word])
    
    print(f"Stopwords personalizadas basadas en baja entropía guardadas en {ruta_csv_stopwords_salida}")
...
if __name__ == '__main__':
    ...
    ruta_csv_stopwords_salida = 'stopwords_personalizadas_baja_entropia.csv'  # Ruta donde se guardarán las stopwords
